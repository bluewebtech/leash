...
class PHPGraphLibPie extends PHPGraphLib {
	...
	var $pie_3D_height_percent = 0; //is % of total width 
	...
	var $pie_center_x_offset = 60; //in %
	var $pie_center_legend_scale = 55; //offset in % of existing coords when legend
	var $pie_width_percent = 100; //default width % of total width
	var $pie_height_percent = 100; 
